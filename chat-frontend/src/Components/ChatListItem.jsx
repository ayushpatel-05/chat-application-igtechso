export default function ChatListItem({name, unread, url, unreadCount = 1, id, handelChatSelect}) {
    return (
        <li onClick={() => handelChatSelect(id)} className="flex items-center text-sm text-gray-300 hover:text-white cursor-pointer">
